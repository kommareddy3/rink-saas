...
- Name: nav-scroll.spec.ts >> Navigation & scroll >> Clicking a /#tools / 'See all tools' link from another route scrolls to that section
- Location: e2e/nav-scroll.spec.ts:63:3
