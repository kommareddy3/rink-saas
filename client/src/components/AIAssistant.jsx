...
export default function AIAssistant() {
  ...
  const [messages, setMessages] = useState([
    {
      type: "bot",
      content: "Hi! I'm RINK AI Assistant. I can help you with questions about AI, machine learning models, time series prediction, and how to use our platform. What would you like to know?",
      timestamp: new Date()
    }
  ]);
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-t-2xl">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100">AI & ML Expert</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-gray-300 bg-white">
            <div className="flex space-x-2">
              <input
                ...
                placeholder="Ask me about AI, models, predictions..."
